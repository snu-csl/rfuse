...
typedef struct fuse_req *old_fuse_req_t;
typedef struct rfuse_user_req *fuse_req_t;
...
/** Directory entry parameters supplied to old_fuse_reply_entry() */
 ...
 * receive a request handle (old_fuse_req_t) as their first argument.
 ...
 * old_fuse_reply_open() return -ENOENT means, that the release method for
...
struct fuse_lowlevel_ops {
	 ...
	 */
	void (*old_lookup) (old_fuse_req_t req, fuse_ino_t parent, const char *name);
	 ...
	 * old_fuse_reply_entry and old_fuse_reply_create. The nlookup parameter
	 ...
	 */
	void (*old_forget) (old_fuse_req_t req, fuse_ino_t ino, uint64_t nlookup);
	void (*forget) (fuse_req_t u_req, fuse_ino_t ino, uint64_t nlookup);
	 ...
	 */
	void (*old_getattr) (old_fuse_req_t req, fuse_ino_t ino,
	 ...
	 */
	void (*old_setattr) (old_fuse_req_t req, fuse_ino_t ino, struct stat *attr,
	 ...
	 *
	 * Valid replies:
	 *   old_fuse_reply_readlink
	 *   old_fuse_reply_err
	 *
	 * @param req request handle
	 * @param ino the inode number
	 */
	void (*old_readlink) (old_fuse_req_t req, fuse_ino_t ino);
	 ...
	 */
	void (*old_mknod) (old_fuse_req_t req, fuse_ino_t parent, const char *name,
	 ...
	 */
	void (*old_mkdir) (old_fuse_req_t req, fuse_ino_t parent, const char *name,
		       mode_t mode);
	void (*mkdir) (fuse_req_t u_req, fuse_ino_t parent, const char *name,
		       mode_t mode);
	 ...
	 */
	void (*old_unlink) (old_fuse_req_t req, fuse_ino_t parent, const char *name);
	void (*unlink) (fuse_req_t u_req, fuse_ino_t parent, const char *name);
	 ...
	 * @param name to remove
	 */
	void (*old_rmdir) (old_fuse_req_t req, fuse_ino_t parent, const char *name);
	void (*rmdir) (fuse_req_t u_req, fuse_ino_t parent, const char *name);
	 ...
	 * @param name to create
	 */
	void (*old_symlink) (old_fuse_req_t req, const char *link, fuse_ino_t parent,
			 const char *name);
	 ...
	 */
	void (*old_rename) (old_fuse_req_t req, fuse_ino_t parent, const char *name,
	 ...
	 */
	void (*old_link) (old_fuse_req_t req, fuse_ino_t ino, fuse_ino_t newparent,
		      const char *newname);
	 ...
	 */
	void (*old_open) (old_fuse_req_t req, fuse_ino_t ino,
		      struct fuse_file_info *fi);
	void (*open) (fuse_req_t u_req, fuse_ino_t ino,
		      struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*old_read) (old_fuse_req_t req, fuse_ino_t ino, size_t size, off_t off,
		      struct fuse_file_info *fi);
	void (*read) (fuse_req_t u_req, fuse_ino_t ino, size_t size, off_t off,
		      struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*old_write) (old_fuse_req_t req, fuse_ino_t ino, const char *buf,
		       size_t size, off_t off, struct fuse_file_info *fi);
	void (*write) (fuse_req_t u_req, fuse_ino_t ino, const char *buf,
		       size_t size, off_t off, struct fuse_file_info *fi);
	/**
	 * Flush method
	 *
	 ...
	 */
	void (*old_flush) (old_fuse_req_t req, fuse_ino_t ino,
		       struct fuse_file_info *fi);	

	void (*flush) (fuse_req_t u_req, fuse_ino_t ino, struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*old_release) (old_fuse_req_t req, fuse_ino_t ino,
			 struct fuse_file_info *fi);
	void (*release) (fuse_req_t u_req, fuse_ino_t ino,
			 struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*old_fsync) (old_fuse_req_t req, fuse_ino_t ino, int datasync,
		       struct fuse_file_info *fi);
	void (*fsync) (fuse_req_t u_req, fuse_ino_t ino, int datasync,
		       struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*old_opendir) (old_fuse_req_t req, fuse_ino_t ino,
			 struct fuse_file_info *fi);
	void (*opendir) (fuse_req_t u_req, fuse_ino_t ino,
			 struct fuse_file_info *fi);

	/**
	 * Read directory
	 *
	 * Send a buffer filled using old_fuse_add_direntry(), with size not
	 ...
	 * @param fi file information
	 */
	void (*old_readdir) (old_fuse_req_t req, fuse_ino_t ino, size_t size, off_t off,
			 struct fuse_file_info *fi);
	void (*readdir) (fuse_req_t u_req, fuse_ino_t ino, size_t size, off_t off,
			 struct fuse_file_info *fi);
	/**
	 ...
	 * @param fi file information
	 */
	void (*old_releasedir) (old_fuse_req_t req, fuse_ino_t ino,
			    struct fuse_file_info *fi);
	void (*releasedir) (fuse_req_t u_req, fuse_ino_t ino,
			    struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*old_fsyncdir) (old_fuse_req_t req, fuse_ino_t ino, int datasync,
			  struct fuse_file_info *fi);
	 ...
	 *
	 * Valid replies:
	 *   old_fuse_reply_statfs
	 *   old_fuse_reply_err
	 *
	 * @param req request handle
	 * @param ino the inode number, zero means "undefined"
	 */
	void (*old_statfs) (old_fuse_req_t req, fuse_ino_t ino);
	 ...
	 *   old_fuse_reply_err
	 */
	void (*old_setxattr) (old_fuse_req_t req, fuse_ino_t ino, const char *name,
	 ...
	 * old_fuse_reply_xattr.
	 *
	 * If the size is non-zero, and the value fits in the buffer, the
	 * value should be sent with old_fuse_reply_buf.
	 *
	 ...
	 */
	void (*old_getxattr) (old_fuse_req_t req, fuse_ino_t ino, const char *name,
			  size_t size);
	 ...
	 * sent with old_fuse_reply_xattr.
	 *
	 ...
	 */
	void (*old_listxattr) (old_fuse_req_t req, fuse_ino_t ino, size_t size);
	 ...
	 * @param name of the extended attribute
	 */
	void (*old_removexattr) (old_fuse_req_t req, fuse_ino_t ino, const char *name);
	 ...
	 */
	void (*old_access) (old_fuse_req_t req, fuse_ino_t ino, int mask);
	 ...
	 * @param fi file information
	 */
	void (*old_create) (old_fuse_req_t req, fuse_ino_t parent, const char *name,
			mode_t mode, struct fuse_file_info *fi);
	void (*create) (fuse_req_t u_req, fuse_ino_t parent, const char *name,
			mode_t mode, struct fuse_file_info *fi);
	/**
	 ...
	 */
	void (*old_getlk) (old_fuse_req_t req, fuse_ino_t ino,
	 ...
	 */
	void (*old_setlk) (old_fuse_req_t req, fuse_ino_t ino,
		       struct fuse_file_info *fi,
	 ...
	 */
	void (*old_bmap) (old_fuse_req_t req, fuse_ino_t ino, size_t blocksize,
		      uint64_t idx);
	void (*bmap) (fuse_req_t req, fuse_ino_t ino, size_t blocksize,
		      uint64_t idx);

#if FUSE_USE_VERSION < 35
	void (*old_ioctl) (old_fuse_req_t req, fuse_ino_t ino, int cmd,
	 ...
	 */
	void (*old_ioctl) (old_fuse_req_t req, fuse_ino_t ino, unsigned int cmd,
		       void *arg, struct fuse_file_info *fi, unsigned flags,
		       const void *in_buf, size_t in_bufsz, size_t out_bufsz);
	 ...
	 */
	void (*old_poll) (old_fuse_req_t req, fuse_ino_t ino, struct fuse_file_info *fi,
	 ...
	 * @param fi file information
	 */
	void (*old_write_buf) (old_fuse_req_t req, fuse_ino_t ino,
	 ...
	 */
	void (*old_retrieve_reply) (old_fuse_req_t req, void *cookie, fuse_ino_t ino,
	 ...
	 * @param req request handle
	 */
	void (*old_forget_multi) (old_fuse_req_t req, size_t count,
	 ...
	 */
	void (*old_flock) (old_fuse_req_t req, fuse_ino_t ino,
	 ...
	 *             see fallocate(2)
	 */
	void (*old_fallocate) (old_fuse_req_t req, fuse_ino_t ino, int mode,
	 ...
	 * @param fi file information
	 */
	void (*old_readdirplus) (old_fuse_req_t req, fuse_ino_t ino, size_t size, off_t off,
			 struct fuse_file_info *fi);
	 ...
	 */
	void (*old_copy_file_range) (old_fuse_req_t req, fuse_ino_t ino_in,
	 ...
	 * @param fi file information
	 */
	void (*old_lseek) (old_fuse_req_t req, fuse_ino_t ino, off_t off, int whence,
		       struct fuse_file_info *fi);
 ...
 */
int old_fuse_reply_err(old_fuse_req_t req, int err);
 ...
 * @return zero for success, -errno for failure to send reply
 */
int old_fuse_reply_readlink(old_fuse_req_t req, const char *link);
 ...
 * @return zero for success, -errno for failure to send reply
 */
int old_fuse_reply_open(old_fuse_req_t req, const struct fuse_file_info *fi);
 ...
 * be used (the first call to old_fuse_add_direntry should be passed the
 ...
 *
 * See documentation of `old_fuse_add_direntry()` for more details.
 *
 * @param req request handle
 * @param buf the point where the new entry will be added to the buffer
 * @param bufsize remaining size of the buffer
 ...
 */
typedef void (*old_fuse_interrupt_func_t)(old_fuse_req_t req, void *data);
 ...
 * fuse_session_mount() and old_fuse_session_loop().
 *
 ...
 * old_fuse_session_loop().
 *
 * @param se the session
 * @param config session loop configuration 
 * @return see old_fuse_session_loop()
 */
