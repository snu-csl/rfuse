...
struct cuse_lowlevel_ops {
	...
	void (*open) (old_fuse_req_t req, struct fuse_file_info *fi);
	void (*read) (old_fuse_req_t req, size_t size, off_t off,
		      struct fuse_file_info *fi);
	void (*write) (old_fuse_req_t req, const char *buf, size_t size, off_t off,
		       struct fuse_file_info *fi);
	void (*flush) (old_fuse_req_t req, struct fuse_file_info *fi);
	void (*release) (old_fuse_req_t req, struct fuse_file_info *fi);
	void (*fsync) (old_fuse_req_t req, int datasync, struct fuse_file_info *fi);
	void (*ioctl) (old_fuse_req_t req, int cmd, void *arg,
		       struct fuse_file_info *fi, unsigned int flags,
		       const void *in_buf, size_t in_bufsz, size_t out_bufsz);
	void (*poll) (old_fuse_req_t req, struct fuse_file_info *fi,
