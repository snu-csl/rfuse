...
FUSE_SYMVER("old_fuse_session_loop_mt_32", "fuse_session_loop_mt@@FUSE_3.2")
...
int old_fuse_session_loop_mt_31(struct fuse_session *se, int clone_fd);
FUSE_SYMVER("old_fuse_session_loop_mt_31", "fuse_session_loop_mt@FUSE_3.0")
int old_fuse_session_loop_mt_31(struct fuse_session *se, int clone_fd)
{
	struct fuse_loop_config config;
	config.clone_fd = clone_fd;
	config.max_idle_threads = 10;
	return old_fuse_session_loop_mt_32(se, &config);
}
